...
pth <- paste(getwd(), "data", "stop_level_passenger_census_sorted_by_location_id_(weekday).pdf", sep="/")
...
for (idx in 1:length((list_data))){
    ...
    output_path <- glue("{getwd()}/data/stop_level_ridership_spring_2024/stops_{idx}.txt")
